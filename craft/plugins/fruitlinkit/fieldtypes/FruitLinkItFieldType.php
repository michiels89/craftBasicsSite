...
class FruitLinkItFieldType extends BaseFieldType
{
    ...
    public function getInputHtml($name, $value)
    {
		...
		// if you want to overwrite the default CTA styling, add an array called 'ctaStyles'
	    // to your general config that contains class => label values
        if(craft()->config->get('ctaStyles')) {
	        $classes = craft()->config->get('ctaStyles');
        } else {
            $classes = [
				'btn'                   => 'Primary',
