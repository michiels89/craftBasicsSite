        ...
        switch ($attribute) {
            ...
            default:
                ...
                if (strpos($attribute, $columnPrefix) === 0) {
                    ...
                    if ($field && $field->type === FieldInterface::TYPE_FILE) {
                        if (!is_array($value)) {
                            if ($value) {
                                $value = [$value];
                            } else {
                        ...
                        foreach ($value as $item) {
                            $asset = craft()->assets->getFileById($item);
                    ...
                    if (null !== $field) {
                        if ($field->type === FieldInterface::TYPE_CHECKBOX) {
                            return $value ?: '-';
                        }

                        if ($field->type === FieldInterface::TYPE_RATING) {
