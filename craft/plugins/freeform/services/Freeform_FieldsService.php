...
class Freeform_FieldsService extends BaseApplicationComponent implements FieldHandlerInterface
{
    ...
    public function getFieldTypes()
    {
        ...
        if (file_exists($path) && is_dir($path)) {
            ...
            foreach ($files as $file) {
                ...
                if ($className !== $recaptcha && $reflectionClass->implementsInterface($interface)) {
    ...
    public function onBeforeValidate(AbstractField $field, Form $form)
    {
        ...
        $this->raiseEvent(FreeformPlugin::EVENT_BEFORE_VALIDATE, $event);
    ...
    {
        $event = new Event($this, ['field' => $field, 'form' => $form]);
        $this->raiseEvent(FreeformPlugin::EVENT_AFTER_VALIDATE, $event);
