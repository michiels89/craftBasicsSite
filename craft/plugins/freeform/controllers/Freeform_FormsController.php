...
class Freeform_FormsController extends Freeform_BaseController
{
    ...
    public function actionIndex()
    {
        ...
        craft()->templates->includeCssResource('freeform/css/form-index.css');
    ...
    public function actionDuplicate()
    {
        ...
        if (!$model) {
            throw new FreeformException(
                Craft::t('Form with ID {id} not found', ['id' => $id])
            );
        }

        $model->id = null;
        $layout    = JsonHelper::decode($model->layoutJson, true);
        ...
        $model->layoutJson = JsonHelper::encode($layout);

        $this->getFormService()->save($model);
        ...
        if ($model->getErrors()) {
            ...
            craft()->userSession->setError($string);
        }
    ...
    public function actionEdit(array $variables = [])
    {
        ...
        $templateVariables = [
            ...
            'isRecaptchaEnabled'       => $this->getSettingsService()->isRecaptchaEnabled(),
        ];
