...
class Freeform_SettingsController extends Freeform_BaseController
{
     ...
     */
    public function actionProvideSetting(array $variables = [])
    {
        craft()->templates->includeCssResource("freeform/css/code-pack.css");

        $this->provideTemplate(isset($variables['template']) ? $variables['template'] : 'general');
    }
    ...
    private function provideTemplate($template)
    {
        ...
        $this->renderTemplate(
            ...
            [
                'settings'   => $this->getSettingsModel(),
                'navigation' => $this->getSettingsService()->getNavigation(),
            ]
        );
    }
